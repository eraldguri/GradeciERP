...
public class TokenService : ITokenService
{
    ...
    public async Task<TokenResponse> LoginAsync(TokenRequest request)
    {
        ...
        var validUpTo = _tenantContextAccessor.MultiTenantContext?.TenantInfo?.ValidUpTo;
        ...
        if (tenantId is not TenancyConstants.Root.Id)
        {
            if (validUpTo < DateTime.UtcNow)
            {
    ...
    {
        var tenantId = _tenantContextAccessor.MultiTenantContext?.TenantInfo?.Id ?? string.Empty;
